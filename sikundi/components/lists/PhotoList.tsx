    ...
    return (
        <div className={styles}>
            <div className='flex flex-wrap items-center px-4 mb-6'>
                <Heading level={20} className="text-accent font-light md:mb-0 mr-auto mb-3">All Photos</Heading>
                ...
                <tbody>
                    {
                        ...
                        props.articles?.map((item:any, index:any)=>{
                            return (
                                <tr className='text-accent hover:opacity-50 cursor-pointer' key={index} onClick={()=>router.push(`/photos/${item?.id}/update`)}>
                        ...
                        <tr>
                            <td className="text-center p-4 text-accent font-bold" colSpan={3}>no Photos at the moment</td>
                        </tr>
                    }
                </tbody>
            </table>
